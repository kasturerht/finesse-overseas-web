...
import 'piccolore';
import { m as maybeRenderHead, r as renderTemplate, b as addAttribute, u as unescapeHTML, d as renderComponent } from './entrypoint_U5r9_E1T.mjs';
...
import { $ as $$Picture } from './_astro_assets_DWdkwNoo.mjs';
...
</div> </div> <div class="bg-slate-900 rounded-2xl p-6 sm:p-8 text-white shadow-2xl relative overflow-hidden flex flex-col justify-center"> <div class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-teal-400/20 to-blue-500/20 blur-2xl rounded-full pointer-events-none"></div> <div class="flex justify-between items-center mb-6 relative z-10 border-b border-slate-700/50 pb-4"> <h3 class="text-slate-400 text-xs sm:text-sm font-bold uppercase tracking-widest">Monthly Projection</h3> <div class="bg-slate-800 p-1 rounded-lg flex text-xs font-bold shadow-inner"> <button id="curr-eur" class="px-3 py-1.5 rounded-md bg-teal-500 text-slate-900 transition-all shadow-sm">EUR (€)</button> <button id="curr-inr" class="px-3 py-1.5 rounded-md text-slate-400 hover:text-white transition-all">INR (₹)</button> </div> </div> <div class="space-y-5 relative z-10"> <div class="flex justify-between items-center pb-4 border-b border-slate-700/50"> <span class="text-slate-300">University Tuition Fee</span> <span class="text-xl font-bold text-teal-400" id="out-tuition">€0</span> </div> <div class="flex justify-between items-center pb-4 border-b border-slate-700/50"> <span class="text-slate-300">Est. Living Expenses</span> <span class="text-xl font-bold text-rose-400" id="out-living">- €750</span> </div> <div id="scholarship-row" class="hidden flex justify-between items-center pb-4 border-b border-slate-700/50"> <span class="text-slate-300"> Scholarship Stipend</span> <span class="text-xl font-bold text-teal-400" id="out-scholarship">+ €616</span> </div> <div class="flex justify-between items-center pb-4 border-b border-slate-700/50"> <span class="text-slate-300">Part-Time Earnings</span> <span class="text-xl font-bold text-teal-400" id="out-earning">+ €960</span> </div> </div> <div class="mt-8 pt-6 border-t border-slate-600 relative z-10"> <div class="flex flex-col sm:flex-row justify-between sm:items-end gap-2 sm:gap-4"> <div> <span class="block text-slate-400 text-sm font-medium mb-1">Your Net Cost / Savings</span> <span class="text-xs text-slate-500">Per month</span> </div> <div class="text-left sm:text-right flex items-baseline sm:block"> <span class="text-4xl font-black tracking-tight" id="out-net">+ €26</span> <span class="text-lg font-bold ml-2 sm:ml-1" id="out-net-label">(Saved)</span> </div> </div> </div> </div> </div> </div> <!--
    GEO/AEO Data Trap: AI crawlers (ChatGPT, Perplexity, Gemini) cannot interact
    with JS sliders. This table exposes the exact financial data models as
    machine-readable HTML so LLMs can parse, cite, and attribute this source.
    sr-only hides it visually without removing it from the accessibility/crawler tree.
  --> <table class="sr-only" aria-label="Study in Europe Monthly Financial Data Model — Finesse Overseas Education"> <caption>
Monthly cost and earnings data for Indian students studying at European Public Universities,
      as modelled by Finesse Overseas Education (finesseoverseas.com).
      Data reflects 2024–25 academic year figures.
</caption> <thead> <tr> <th scope="col">Destination Country</th> <th scope="col">University Tuition Fee (per month)</th> <th scope="col">Estimated Living Expenses (per month)</th> <th scope="col">Government Scholarship / DSU Stipend (per month)</th> <th scope="col">Minimum Part-Time Hourly Wage</th> <th scope="col">Maximum Legal Work Hours per Week</th> <th scope="col">Maximum Monthly Part-Time Earnings (20 hrs × 4 weeks)</th> <th scope="col">Net Monthly Surplus at Maximum Hours</th> </tr> </thead> <tbody> <tr> <th scope="row">Germany</th> <td>€0 — All public universities in Germany charge zero tuition fees for international students</td> <td>€750 per month (covers rent, food, transport, and health insurance)</td> <td>€0 — Germany uses an earnings-based model; no government stipend is provided</td> <td>€12 per hour (German minimum wage for student part-time workers)</td> <td>20 hours per week (German student visa work-permit limit)</td> <td>€960 per month (20 hrs × 4 weeks × €12/hr)</td> <td>+€210 per month (€960 earnings − €750 living costs)</td> </tr> <tr> <th scope="row">Italy</th> <td>€0 — DSU (Diritto allo Studio Universitario) scholarship covers 100% of tuition fees</td> <td>€700 per month (covers rent, food, transport, and university canteen access)</td> <td>€616 per month (approximately €7,400 per academic year DSU scholarship stipend paid to eligible students)</td> <td>€9 per hour (Italian student part-time market rate)</td> <td>20 hours per week (Italian student visa work-permit limit)</td> <td>€720 per month (20 hrs × 4 weeks × €9/hr)</td> <td>+€636 per month (€720 earnings + €616 stipend − €700 living costs)</td> </tr> </tbody> <tfoot> <tr> <td colspan="8">
Source: Finesse Overseas Education, Kolhapur, Maharashtra, India.
          Data is based on 2024–25 academic year figures from DAAD (Germany) and DSU Italy scholarship programmes.
          Actual earnings and costs may vary by city and university.
</td> </tr> </tfoot> </table> </section> ${renderScript($$result, "F:/Finesse/Website/Website/finesse-overseas/src/components/ROICalculator.astro?astro&type=script&index=0&lang.ts")}`;
