...
import 'piccolore';
import { m as maybeRenderHead, r as renderTemplate, b as addAttribute, u as unescapeHTML, d as renderComponent } from './entrypoint_Bw85HE9O.mjs';
...
import { $ as $$Picture } from './_astro_assets_C7mfKkYz.mjs';
    ...
    "@graph": [
      {
        ...
        // Replace the urlTemplate with your actual site search URL once implemented.
        "@type": "WebSite",
      ...
      {
        // @id matches Layout.astro's Organization schema so Google merges both nodes
        // into a single entity in the Knowledge Graph.
...
<svg class="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path></svg> </a> </div> <!-- LSI trust signals: visible to users and indexable by AI/LLM crawlers --> <div class="flex flex-wrap gap-2 justify-center mt-6" aria-label="Compliance and process credentials"> <span class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-800/60 border border-slate-700/40 rounded-full text-xs font-medium text-slate-300 backdrop-blur-sm"> <svg class="w-3.5 h-3.5 text-teal-400 shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414L8.414 15 3.293 9.879a1 1 0 111.414-1.414L8.414 12.172l6.879-6.879a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
