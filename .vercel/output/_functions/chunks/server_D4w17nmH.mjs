import { j as createInvalidVariablesError, k as getEnv$1, l as setOnSetGetEnv } from './entrypoint_DnIltG5M.mjs';
...
setOnSetGetEnv(() => {
	OAUTH_GITHUB_CLIENT_ID = _internalGetSecret("OAUTH_GITHUB_CLIENT_ID");
OAUTH_GITHUB_CLIENT_SECRET = _internalGetSecret("OAUTH_GITHUB_CLIENT_SECRET");
OAUTH_GITHUB_REPO_ID = _internalGetSecret("OAUTH_GITHUB_REPO_ID");
