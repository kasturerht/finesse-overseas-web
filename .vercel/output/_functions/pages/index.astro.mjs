import { c as createComponent, m as maybeRenderHead, f as renderScript, r as renderTemplate, a as addAttribute, e as createAstro, u as unescapeHTML, d as renderComponent } from '../chunks/astro/server_CtiDgme8.mjs';
import 'piccolore';
import { $ as $$Layout } from '../chunks/Layout_CXIv05Z3.mjs';
import 'clsx';
import { $ as $$Footer } from '../chunks/Footer_DAr88P5j.mjs';
import { $ as $$WhatsAppWidget } from '../chunks/WhatsAppWidget_bfhP8rHn.mjs';
/* empty css                                 */
import { $ as $$Picture } from '../chunks/_astro_assets_C0dehVAO.mjs';
...
const $$FAQ = createComponent(($$result, $$props, $$slots) => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "The APS (Akademische Pr\xFCfstelle) certificate is a mandatory document for Indian students applying to German universities. It verifies the authenticity of your Indian academic documents. Finesse handles the entire APS notarization and application process to ensure zero delays."
    },
    {
