    ...
    <section className="relative flex flex-col bg-slate-950 overflow-hidden selection:bg-teal-500/20 selection:text-teal-300">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full pt-24 pb-12 lg:pt-32 lg:pb-16">
        <div className="flex flex-col lg:flex-row items-center gap-14 lg:gap-20">
          ...
          >
            {/* Badge */}
            <motion.div variants={fadeUp} className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-slate-900/80 border border-teal-500/20 mb-8 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
            ...
            {/* CTAs */}
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-center gap-4 w-full">
              <button className="w-full sm:w-auto px-8 py-4 bg-slate-100 hover:bg-white text-slate-900 font-bold rounded-xl shadow-[0_0_0_1px_rgba(255,255,255,0.1)] hover:shadow-[0_8px_24px_rgba(255,255,255,0.12)] hover:-translate-y-0.5 transition-all duration-300">
                Book Free Counseling
              </button>
              <button className="w-full sm:w-auto px-8 py-4 bg-transparent border border-slate-700 hover:border-slate-500 text-slate-300 font-bold rounded-xl hover:bg-slate-900/60 transition-all duration-300">
                Compare Options
              </button>
            </motion.div>
          </motion.div>
            ...
            <div className="relative bg-slate-900/70 backdrop-blur-2xl border border-white/[0.06] rounded-[2rem] shadow-[0_32px_64px_-20px_rgba(0,0,0,0.7),inset_0_1px_0_rgba(255,255,255,0.06)] p-8 md:p-10">
              ...
              <form className="space-y-5">
                ...
                <div className="flex items-start gap-2 justify-center pt-1">
                  <svg className="w-3.5 h-3.5 text-slate-600 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path
                      fillRule="evenodd"
