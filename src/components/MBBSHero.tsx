...
// 🎓 Trust Slider Data: Aspiration & Security (Images Verified & Fixed)
const trustSlides = [
  {
    id: 1,
  ...
  {
    id: 2,
    image: "https://images.unsplash.com/photo-1541829070764-84a7d30dd3f3?auto=format&fit=crop&q=80&w=1600", // Grand University Campus
...
export default function MBBSHero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-28 pb-24 overflow-hidden bg-[#030712] selection:bg-teal-500/30">
      ...
      {/* --- UPGRADED BACKGROUND: Medical Network & Deep Glow --- */}
      ...
      <div className="max-w-[1400px] w-full mx-auto px-4 sm:px-6 relative z-10 grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        {/* ============================================================ */}
        {/* 🛡️ LEFT SIDE: PERFECTED TYPOGRAPHY & GLOW SLIDER */}
        {/* ============================================================ */}
        <div className="lg:col-span-7 flex flex-col justify-center gap-8">
          
          {/* Typography Masterpiece - Fixed Line Breaks */}
          <div className="space-y-6">
            ...
            >
              ...
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-teal-400 via-emerald-400 to-cyan-500 pb-2 relative">
                ...
                {/* Subtle Shimmer Overlay on Text */}
          ...
          {/* 🖼️ THE UPGRADED TRUST SLIDER (Soft Glow & Deep Borders) */}
          <motion.div 
          ...
          >
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <img 
                  src={trustSlides[currentSlide].image} 
                  alt={trustSlides[currentSlide].title} 
                ...
                <div className="absolute bottom-0 left-0 w-full p-6 sm:p-8 z-20">
                  <h3 className="text-xl sm:text-2xl font-black text-white mb-2 tracking-tight drop-shadow-lg">
                    {trustSlides[currentSlide].title}
                  </h3>
                  <p className="text-sm text-slate-300 font-medium max-w-md drop-shadow-md">
              ...
              {trustSlides.map((_, idx) => (
                <div key={idx} className="h-1.5 flex-1 bg-white/10 rounded-full overflow-hidden backdrop-blur-md border border-white/5">
                  {idx === currentSlide && (
                    <motion.div 
                      layoutId="progress" 
                      className="h-full bg-gradient-to-r from-teal-500 to-cyan-400 w-full origin-left shadow-[0_0_10px_rgba(20,184,166,0.8)]"
                      initial={{ scaleX: 0 }}
                      animate={{ scaleX: 1 }}
          ...
          >
            {[
              "NMC 2026 Guidelines Followed",
              "Direct University Tie-ups",
              "NExT Exam Coaching Support"
            ].map((badge, i) => (
        ...
        {/* ============================================================ */}
        {/* 📋 RIGHT SIDE: PREMIUM COUNSELING FORM */}
        {/* ============================================================ */}
        <motion.div 
            ...
            <div className="bg-[#080d1a]/95 backdrop-blur-3xl rounded-[2rem] p-8 sm:p-10 border border-white/[0.05]">
              ...
              <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="space-y-1.5 group">
                  ...
                  <input type="text" placeholder="Enter full name" className="w-full bg-white/5 border border-white/10 rounded-xl px-5 py-4 text-white placeholder:text-slate-600 focus:bg-white/10 focus:border-teal-500/50 outline-none transition-all duration-300 shadow-inner" />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5 group">
                    ...
                    <input type="number" placeholder="Expected Score" className="w-full bg-white/5 border border-white/10 rounded-xl px-5 py-4 text-white placeholder:text-slate-600 focus:bg-white/10 focus:border-teal-500/50 outline-none transition-all duration-300" />
                  </div>
                  <div className="space-y-1.5 group">
                    ...
                    <select className="w-full bg-white/5 border border-white/10 rounded-xl px-5 py-4 text-slate-300 focus:bg-white/10 focus:border-teal-500/50 outline-none transition-all duration-300 appearance-none cursor-pointer">
                      <option className="bg-slate-900">Select Range</option>
                      <option className="bg-slate-900">20 - 25 Lakhs</option>
                      <option className="bg-slate-900">25 - 35 Lakhs</option>
                    </select>
                  </div>
                </div>
                ...
                <div className="space-y-1.5 group">
                  ...
                  <div className="relative flex items-center">
                    ...
                    <input type="tel" placeholder="00000 00000" className="w-full bg-white/5 border border-white/10 rounded-xl pl-14 pr-5 py-4 text-white placeholder:text-slate-600 focus:bg-white/10 focus:border-teal-500/50 outline-none transition-all duration-300" />
                  </div>
                </div>

                <button className="relative w-full group overflow-hidden rounded-xl mt-6 shadow-[0_10px_20px_-10px_rgba(20,184,166,0.5)]">
                  ...
                  <div className="relative px-6 py-4 flex items-center justify-center gap-2">
                    <span className="text-sm font-black text-slate-950 uppercase tracking-widest">Get Free Counseling</span>
                    <svg className="w-5 h-5 text-slate-950 transform group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
                  </div>
                </button>
