  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-[860px] mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20 flex flex-col items-center text-center">
        ...
        >
          {/* Primary — white */}
          <button className="group inline-flex items-center gap-2.5 px-7 py-3.5 bg-white hover:bg-slate-50 text-teal-700 font-bold text-sm rounded-xl shadow-[0_8px_24px_-6px_rgba(0,0,0,0.2)] hover:shadow-[0_12px_32px_-6px_rgba(0,0,0,0.25)] hover:-translate-y-0.5 transition-all duration-300">
            <CalendarIcon />
          ...
          <a
            ...
            className="group inline-flex items-center gap-2.5 px-7 py-3.5 bg-white/10 hover:bg-white/20 border border-white/30 hover:border-white/50 text-white font-bold text-sm rounded-xl backdrop-blur-sm hover:-translate-y-0.5 transition-all duration-300"
          >
            <PhoneIcon />
            Call +91 98500 69600
          </a>
